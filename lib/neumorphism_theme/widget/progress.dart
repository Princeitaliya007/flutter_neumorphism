...
/// A style to customize the [NeumorphismProgress]
///
...
///
/// NeumorphismProgress is determinate.
///
...
///  ```
///
class NeumorphismProgress extends StatefulWidget {
  ...
  @override
  _NeumorphismProgressState createState() => _NeumorphismProgressState();
...
class _NeumorphismProgressState extends State<NeumorphismProgress>
  ...
  @override
  void didUpdateWidget(NeumorphismProgress oldWidget) {
...
/// A widget that shows progress along a line.
///
/// NeumorphismProgressIndeterminate is indeterminate.
///
...
///
///  ```
///  NeumorphismProgressIndeterminate(
///      height: 15,
///  );
///
///  ```
///
class NeumorphismProgressIndeterminate extends StatefulWidget {
  final double height;
  final ProgressStyle style;
  final Duration duration;
  final bool reverse;
  ...
  const NeumorphismProgressIndeterminate({
    Key? key,
    this.height = 10,
    this.style = const ProgressStyle(),
  ...
  @override
  createState() => _NeumorphismProgressIndeterminateState();

  @override
  // ignore: invalid_override_of_non_virtual_member
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is NeumorphismProgressIndeterminate &&
          runtimeType == other.runtimeType &&
          height == other.height &&
          style == other.style &&
...
class _NeumorphismProgressIndeterminateState
    extends State<NeumorphismProgressIndeterminate>
    with TickerProviderStateMixin {
  late AnimationController _controller;
  late Animation _animation;
