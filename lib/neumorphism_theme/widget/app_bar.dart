...
class NeumorphismAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  ///
  /// Defaults to [NeumorphismAppBar.defaultSpacing].
  ...
  @override
  NeumorphismAppBarState createState() => NeumorphismAppBarState();

  bool _getEffectiveCenterTitle(ThemeData theme, NeumorphismThemeData nTheme) {
...
class NeumorphismAppBarTheme extends InheritedWidget {
  final Widget child;

  NeumorphismAppBarTheme({required this.child}) : super(child: child);
...
class NeumorphismAppBarState extends State<NeumorphismAppBar> {
  @override
  Widget build(BuildContext context) {
    final ThemeData theme = Theme.of(context);
    final nTheme = NeumorphismTheme.of(context);
