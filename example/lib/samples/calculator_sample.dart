...
class WidgetCalcButton extends StatelessWidget {
  ...
  Color _textColor(BuildContext context) {
    if (button.backgroundAccent) {
      ...
      return NeumorphismTheme.accentColor(context);
    } else if (button.textVariant) {
      return NeumorphismTheme.variantColor(context);
    } else {
  ...
  Color? _backgroundColor(BuildContext context) {
    return button.backgroundAccent
        ? NeumorphismTheme.accentColor(context)
        : null;
  }
  ...
  Widget build(BuildContext context) {
    return Neumorphism(
      style: NeumorphismStyle(
        ...
        depth: -1 * NeumorphismTheme.of(context)!.current!.depth,
      ),
                ...
                onPressed: () {
                  setState(() {
                    NeumorphismTheme.of(context)!
                        .updateCurrentTheme(NeumorphismThemeData(
                      depth: 1,
                      intensity: 0.5,
