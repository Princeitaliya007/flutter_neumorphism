...
import 'neumorphism_box_decoration_helper.dart';
import 'neumorphism_emboss_decoration_painter.dart';

class NeumorphismEmptyTextPainter extends BoxPainter {
  NeumorphismEmptyTextPainter({required VoidCallback onChanged})
      : super(onChanged);
...
class NeumorphismDecorationTextPainter extends BoxPainter {
  final NeumorphismStyle style;
  final String text;
  final TextStyle textStyle;
  final TextAlign textAlign;

  NeumorphismPainterCache _cache;
  ...
  NeumorphismDecorationTextPainter({
    required this.style,
  ...
  })  : _cache = NeumorphismPainterCache(),
        super(onChanged) {
    generatePainters();
  }
  ...
  void _drawGradient(
      {required Canvas canvas, required Offset offset, required Path path}) {
    if (style.shape == NeumorphismShape.concave ||
