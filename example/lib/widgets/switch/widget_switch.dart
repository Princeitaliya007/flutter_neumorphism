...
NeumorphismSwitch(
    ...
    style: NeumorphismSwitchStyle(
         thumbShape: NeumorphismShape.flat 
         //or convex, concave
    ),
    onChanged: (value) {
        setState(() {
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              ...
              NeumorphismSwitch(
                style:
                    NeumorphismSwitchStyle(thumbShape: NeumorphismShape.flat),
                value: isChecked,
                onChanged: (value) {
                  setState(() {
                    isChecked = value;
          ...
          Row(
            children: <Widget>[
              ...
              NeumorphismSwitch(
                style: NeumorphismSwitchStyle(
                    thumbShape: NeumorphismShape.concave),
                value: isChecked,
                onChanged: (value) {
                  setState(() {
                    isChecked = value;
          ...
          Row(
            children: <Widget>[
              ...
              NeumorphismSwitch(
                style:
                    NeumorphismSwitchStyle(thumbShape: NeumorphismShape.convex),
                value: isChecked,
                onChanged: (value) {
                  setState(() {
                    isChecked = value;
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          ...
          NeumorphismSwitch(
            value: isChecked,
            style: NeumorphismSwitchStyle(activeTrackColor: currentColor),
            onChanged: (value) {
              setState(() {
                isChecked = value;
              });
