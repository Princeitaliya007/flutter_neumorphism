...
typedef void NeumorphismButtonClickListener();

/// A Neumorphic Button
///
/// When pressed, it will fire a call to its [NeumorphismButtonClickListener] click parameter
...
class _NeumorphismButtonState extends State<NeumorphismButton> {
  ...
  @override
  void didUpdateWidget(NeumorphismButton oldWidget) {
  ...
  Widget _build(BuildContext context) {
    final appBarPresent = NeumorphismAppBarTheme.of(context) != null;
    final appBarTheme = NeumorphismTheme.currentTheme(context).appBarTheme;
