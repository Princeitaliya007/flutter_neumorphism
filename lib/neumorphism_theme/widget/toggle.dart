...
class NeumorphismToggleStyle {
  ...
  bool operator ==(Object other) =>
      ...
      other is NeumorphismToggleStyle &&
...
///),
@immutable
class NeumorphismToggle extends StatelessWidget {
  ...
  final NeumorphismToggleStyle? style;
  final double height;
  final double? width;
  ...
  const NeumorphismToggle({
    this.style = const NeumorphismToggleStyle(),
    Key? key,
  ...
  Widget _background(BuildContext context) {
    return Neumorphism(
      style: NeumorphismStyle(
          ...
          border: style?.border ?? const NeumorphismBorder.none(),
          lightSource: style?.lightSource ??
              NeumorphismTheme.currentTheme(context).lightSource),
