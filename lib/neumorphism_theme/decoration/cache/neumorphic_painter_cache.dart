...
import 'package:flutter_neumorphism/neumorphism_theme/colors.dart';
import 'abstract_neumorphic_painter_cache.dart';

class NeumorphismPainterCache extends AbstractNeumorphicEmbossPainterCache {
  @override
  Color generateShadowDarkColor(
      {required Color color, required double intensity}) {
    return NeumorphismColors.decorationDarkColor(color, intensity: intensity);
  }

  @override
  Color generateShadowLightColor(
      {required Color color, required double intensity}) {
    return NeumorphismColors.decorationWhiteColor(color, intensity: intensity);
  }
